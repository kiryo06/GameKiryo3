...
namespace
{
	...
	constexpr float kJumpAccS = -10.0f;
...
void EnemyJumpRun::Draw()
{
	...
	//x = 210;
	//y = 650;
	DrawRectRotaGraph(x + 16, y + 16, srcX, srcY, kDrawWidth, kDrawHeight, 1.0, 0.0, m_handle, true, m_isAnimTurn);
}
